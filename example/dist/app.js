...
(function($PS) {
  ...
  var playChord = function (dictMonadAff) {
      return function (state) {
          return function (chordSymbol) {
              return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadAff.MonadEffect0())(RhythmGuitar_Audio.playChordSymbol(state.instruments)(chordSymbol)(state.chordMap)))(function () {
  ...
  var playChordSequence = function (dictMonadAff) {
      return function (state) {
          return function (chordSymbols) {
              return Data_Foldable.traverse_(((dictMonadAff.MonadEffect0()).Monad0()).Applicative0())(Data_Foldable.foldableArray)(playChord(dictMonadAff)(state))(chordSymbols);
          };
      };
  };
      ...
      var handleAction = function (v) {
          ...
          if (v instanceof Play) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(playChordSequence(Effect_Aff_Class.monadAffAff)(state)([ "C", "Am", "F", "G" ])))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(playChordSequence(Effect_Aff_Class.monadAffAff)(state)([ "C#", "A#m", "F#", "G#" ])))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(playChordSequence(Effect_Aff_Class.monadAffAff)(state)([ "D", "Bm", "G", "A" ])))(function () {
          ...
          throw new Error("Failed pattern match at PlayerComponent (line 73, column 18 - line 91, column 16): " + [ v.constructor.name ]);
      };
